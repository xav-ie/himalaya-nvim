  ...
  describe('build', function()
    ...
    it('builds linear chain A→B→C with correct depths', function()
      local edges = {
        ...
        {
          { id = '1', from = 'Alice' },
          { id = '2', from = 'Bob', subject = 'Reply 1', date = '2024-01-02 10:00:00+00:00' },
          1,
        },
        {
          { id = '2', from = 'Bob' },
          { id = '3', from = 'Carol', subject = 'Reply 2', date = '2024-01-03 10:00:00+00:00' },
          2,
        },
      }
    ...
    it('handles branch A→B and A→C', function()
      local edges = {
        ...
        {
          { id = '1', from = 'Alice' },
          { id = '2', from = 'Bob', subject = 'Reply B', date = '2024-01-02 10:00:00+00:00' },
          1,
        },
        {
          { id = '1', from = 'Alice' },
          { id = '3', from = 'Carol', subject = 'Reply C', date = '2024-01-03 10:00:00+00:00' },
          1,
        },
      }
      local rows = tree.build(edges)
    ...
    it('sorts thread by latest reply, not root date', function()
      local edges = {
        ...
        {
          { id = '1', from = 'Alice' },
          { id = '3', from = 'Carol', subject = 'New reply', date = '2024-03-01 10:00:00+00:00' },
          1,
        },
    ...
    it('assigns thread_idx to each row', function()
      local edges = {
        ...
        {
          { id = '1', from = 'Alice' },
          { id = '2', from = 'Bob', subject = 'Reply', date = '2024-02-02 10:00:00+00:00' },
          1,
        },
    ...
    it('groups interleaved edges from different threads correctly', function()
      local edges = {
        {
          { id = '0' },
          { id = '1', from = 'Alice', subject = 'Thread A root', date = '2024-02-01 10:00:00+00:00' },
          0,
        },
        { { id = '0' }, { id = '10', from = 'Bob', subject = 'Thread B root', date = '2024-01-01 10:00:00+00:00' }, 0 },
        {
          { id = '1', from = 'Alice' },
          { id = '2', from = 'Carol', subject = 'Reply A1', date = '2024-02-02 10:00:00+00:00' },
          1,
        },
        {
          { id = '10', from = 'Bob' },
          { id = '11', from = 'Dave', subject = 'Reply B1', date = '2024-01-02 10:00:00+00:00' },
          1,
        },
      }
      local rows = tree.build(edges)
    ...
    it('groups deeply interleaved edges across 3 threads', function()
      local edges = {
        ...
        {
          { id = '1', from = 'Alice' },
          { id = '2', from = 'Dave', subject = 'T1-R1', date = '2024-03-02 10:00:00+00:00' },
          1,
        },
        {
          { id = '10', from = 'Bob' },
          { id = '11', from = 'Eve', subject = 'T2-R1', date = '2024-02-02 10:00:00+00:00' },
          1,
        },
        {
          { id = '20', from = 'Carol' },
          { id = '21', from = 'Frank', subject = 'T3-R1', date = '2024-01-02 10:00:00+00:00' },
          1,
        },
        {
          { id = '2', from = 'Dave' },
          { id = '3', from = 'Grace', subject = 'T1-R2', date = '2024-03-03 10:00:00+00:00' },
          2,
        },
      }
      local rows = tree.build(edges)
    ...
    it('produces deterministic order regardless of edge input order', function()
      ...
      local edges = {
        {
          { id = '2', from = 'Bob' },
          { id = '3', from = 'Carol', subject = 'Deep', date = '2024-01-03 10:00:00+00:00' },
          2,
        },
        {
          { id = '1', from = 'Alice' },
          { id = '2', from = 'Bob', subject = 'Reply', date = '2024-01-02 10:00:00+00:00' },
          1,
        },
        { { id = '0' }, { id = '1', from = 'Alice', subject = 'Root', date = '2024-01-01 10:00:00+00:00' }, 0 },
      }
    ...
    it('sorts sibling replies by date within a thread', function()
      local edges = {
        ...
        {
          { id = '1', from = 'Alice' },
          { id = '3', from = 'Carol', subject = 'Later', date = '2024-01-03 10:00:00+00:00' },
          1,
        },
        {
          { id = '1', from = 'Alice' },
          { id = '2', from = 'Bob', subject = 'Earlier', date = '2024-01-02 10:00:00+00:00' },
          1,
        },
      }
      local rows = tree.build(edges)
      ...
      local edges = {
        {
          ...
          { id = '6', from = 'Reply Author', subject = 'Reply', date = '2024-01-02 10:00:00+00:00' },
          0,
        },
        {
          { id = '6', from = 'Reply Author' },
          { id = '7', from = 'Deep Author', subject = 'Deep', date = '2024-01-03 10:00:00+00:00' },
          1,
        },
      }
      local rows = tree.build(edges)
      ...
      for i = 1, 14 do
        edges[#edges + 1] = {
          { id = tostring(i), from = 'X' },
          {
            ...
            from = 'Y',
            subject = 'R' .. i,
            date = string.format('2024-01-%02d 10:00:00+00:00', i + 1),
          },
          i,
        }
      end
  ...
  describe('build_prefix (compact)', function()
    ...
    it('deep linear chain uses only 2-char prefix regardless of depth', function()
      ...
      for i = 2, 15 do
        assert.are.equal(
          2,
          vim.fn.strdisplaywidth(rows[i].prefix),
  ...
  describe('build (reverse)', function()
    ...
    it('reversed branch connectors: ┌─ for first/top, ├─ for last/bottom', function()
      ...
      local edges = {
        ...
        {
          { id = '1', from = 'A' },
          { id = '2', from = 'B', subject = 'Older', date = '2024-01-02 10:00:00+00:00' },
          1,
        },
        {
          { id = '1', from = 'A' },
          { id = '3', from = 'C', subject = 'Newer', date = '2024-01-03 10:00:00+00:00' },
          1,
        },
      }
      local rows = tree.build(edges, { reverse = true })
    ...
    it('cycle in edges does not stack overflow', function()
      ...
      local edges = {
        ...
        {
          { id = '1', from = 'A' },
          { id = '2', from = 'B', subject = 'Reply', date = '2024-01-02 10:00:00+00:00' },
          1,
        },
