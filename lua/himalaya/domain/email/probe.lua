...
--- Reset totals when folder or query changes.
--- @param folder string
--- @param qry string
function M.reset_if_changed(folder, qry)
...
--- Check whether totals are known for a cache key.
--- @param cache_key string
--- @return boolean
function M.has_total(cache_key)
  return totals[cache_key] ~= nil
end
